...
export const products: Product[] = [
  {
    ...
    price: "$25",
    rating: 4.8,
    amazonUrl: "https://www.amazon.com/dp/B08V14Z9CV?tag=memoofadomeen-20",
    category: "home",
    badge: "Best Seller",
    prime: true,
  },
  {
    ...
    price: "$22",
    rating: 4.6,
    amazonUrl: "https://www.amazon.com/dp/B08LH26PFT?tag=memoofadomeen-20",
    category: "tech",
    prime: true,
  },
  {
    ...
    price: "$25",
    rating: 4.8,
    amazonUrl: "https://www.amazon.com/dp/B000XFW6OU?tag=memoofadomeen-20",
    category: "apparel",
    badge: "Top Rated",
    prime: true,
  },
  ...
  },
  {
    ...
    price: "$20",
    rating: 4.7,
    amazonUrl: "https://www.amazon.com/dp/B01MXWQSGE?tag=memoofadomeen-20",
    category: "tools",
    prime: true,
  },
  {
    ...
    price: "$15",
    rating: 4.4,
    amazonUrl: "https://www.amazon.com/dp/B01HRF0Z1U?tag=memoofadomeen-20",
    category: "tools",
    badge: "Under $20",
    prime: true,
  },
  ...
  {
    title: "Anker Charging Cable 3-Pack",
    description: "Nylon-braided, tangle-free, nearly indestructible. Everyone needs spare cables.",
    price: "$15",
    rating: 4.7,
    amazonUrl: "https://www.amazon.com/dp/B08PF6Q3M8?tag=memoofadomeen-20",
    category: "tech",
    prime: true,
  },
  {
