...
export const products: Product[] = [
  {
    ...
    price: "$147",
    rating: 4.8,
    amazonUrl: "https://www.amazon.com/dp/B005ABX0NS?tag=memoofadomeen-20",
    category: "top-picks",
    badge: "Best Seller",
    prime: true,
  },
  {
    ...
    price: "$25",
    rating: 4.8,
    amazonUrl: "https://www.amazon.com/dp/B003F24D1M?tag=memoofadomeen-20",
    category: "kitchen",
    prime: true,
  },
  {
  ...
  },
  {
    ...
    price: "$119",
    rating: 4.6,
    amazonUrl: "https://www.amazon.com/dp/B01LXC0AJ1?tag=memoofadomeen-20",
    category: "home",
    prime: true,
  },
  {
    ...
    price: "$89",
    rating: 4.7,
    amazonUrl: "https://www.amazon.com/dp/B0741ZFDVG?tag=memoofadomeen-20",
    category: "beauty",
    badge: "Editor's Pick",
    prime: true,
  },
  {
    ...
    originalPrice: "$209",
    rating: 4.5,
    amazonUrl: "https://www.amazon.com/dp/B01N7GO468?tag=memoofadomeen-20",
    category: "kitchen",
    badge: "24% Off",
    prime: true,
  },
  {
    ...
    price: "$29",
    rating: 4.8,
    amazonUrl: "https://www.amazon.com/dp/B09MY1BRRN?tag=memoofadomeen-20",
    category: "beauty",
    prime: true,
  },
  {
    title: "UGG Scuffette II Slippers",
    description: "Genuine sheepskin slippers that mold to her feet. Year-round cozy comfort.",
    price: "$95",
    rating: 4.7,
    amazonUrl: "https://www.amazon.com/dp/B0CLTFJBJV?tag=memoofadomeen-20",
    category: "top-picks",
    prime: true,
  },
  {
